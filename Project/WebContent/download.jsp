...
<%
    ...
    //파일을 읽어서 출력
    byte[] b = new byte[4096]; //4kb  //요기는 필요에 따라 조정 가능, 한번에 읽을 데이터의 크기
    ...
    if(sMimeType == null){
     //알수 없는 형식의 파일은 
     //application/octet-stream 기본값으로 (알수 없는 파일 형식일때)
     //클라이언트에 전달할 파일의 형식을 정하는 작업입니다. Response Header에 담깁니다
